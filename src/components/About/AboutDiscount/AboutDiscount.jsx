  ...
  return (
    <>
      ...
      <div
        ...
        style={{ backgroundImage: `url('/assets/img/EMF01515.jpg')` }}
      >
        <div className="wrapper">
          <div className="discount-info">
            <span className="saint-text">Success story</span>
            <h2>Brillix develops its own brands</h2>
            <p>
              The Brillix network is being developed and improved, taking into
            ...
            <p className="discount-info__sm">
              ...
              and care. Brillix stores offer their customers the widest and
